...
## Innovation
RescueAI brings together multiple AI agents via LangGraph to collaborate around one user request. The system fuses weather data, OpenStreetMap route planning, Overpass shelter and resource search, medical guidance, and relief information into a coherent rescue plan.
