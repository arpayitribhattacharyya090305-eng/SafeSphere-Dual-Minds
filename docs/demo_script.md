...
5. Show the shelter, medical, resource, and weather insights generated from the multi-agent workflow.
6. Highlight that mapping uses Folium, Nominatim, Overpass, and OSRM with no map key or billing account.
7. Close by emphasizing the production-ready architecture, modular services, and deployment readiness.
